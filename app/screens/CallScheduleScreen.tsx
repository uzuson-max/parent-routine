...
export default function CallScheduleScreen({ onSelect }: { onSelect: (minutes: number) => void }) {
  return (
    <div style={styles.container}>
      <p style={styles.headline}>언제 전화할까?</p>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  optionRow: { display: "flex", gap: 12, width: "100%", maxWidth: 360 },
  optionButton: { flex: 1, padding: "16px 8px", borderRadius: 12, border: "1px solid #333", background: "#1a1a1f", color: "#fff", fontSize: 15, fontWeight: 600, cursor: "pointer" },
};
