...
export default function PhoneInputScreen({
  ...
  return (
    <div style={styles.container}>
      ...
      <button className={TACTILE_PRESS_CLASS} style={styles.button} disabled={!phone} onClick={submit}>{buttonLabel}</button>
    </div>
  );
}
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  headline: { ...typography.headline, color: BRAND.ink, textAlign: "center", margin: 0 },
  subhead: { color: inkAlpha.muted, fontSize: 14, marginTop: 8, marginBottom: 32, textAlign: "center", fontWeight: 500 },
  input: { width: "100%", maxWidth: 320, padding: "14px 16px", ...tactile.input, fontSize: 16 },
  button: { marginTop: 20, width: "100%", maxWidth: 320, padding: "14px 16px", ...tactile.primaryButton, ...typography.ctaLabel },
};
